...
import { attachSystemPromptsCommand } from "./commands/system-prompts";
import { attachRolePromptsCommand } from "./commands/role-prompts";
import { attachUserInstructionsCommand } from "./commands/user-instructions";
...
async function main() {
  ...
  attachSystemPromptsCommand(program);
  attachRolePromptsCommand(program);
  attachUserInstructionsCommand(program);
