/**
 * Standard XML formatting instructions for the apply changes feature
 */
const xmlFormatInstructions = `
...
<changed_files>
  <file>
    ...
    <file_code>
      ...
      // Code of any type will be automatically handled by the system
      // No need to escape special characters or worry about XML compatibility
    </file_code>
  </file>
...
IMPORTANT: Your changes must be in this exact XML format to be applied correctly by the system. The system will automatically handle special characters and code syntax - you don't need to escape anything manually.
</xml_formatting_instructions>
`;
